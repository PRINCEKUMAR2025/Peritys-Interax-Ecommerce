    ...
    return (
        <div>
            <div className='grid sm:grid-rows-1'>
                <div className='flex items-center min-w-screen px-8 pt-4 bg-red-700 text-white'>
                    <Link
                        href={'/'}
                    ...
                    >
                        ...
                        <button
                            type='submit'
                            className='bg-red-950 rounded-r px-2 border-r border-y border-slate-900 py-1 px-4
                    ...
                    <div className='flex items-center space-x-8 text-xl mx-4 z-10'>
                        <div className='relative'>
                            <div className='flex relative'>
                                ...
                                <p className='text-red-950 absolute top-0 right-1'>0</p>
                            </div>
                        ...
                        <div className='flex relative'>
                            ...
                            <p className='text-red-950 absolute top-0 right-1'>{selectedProducts.length}</p>
                        </div>
                    </div>
                </div>

                {/* Add the Categories component here */}
                <Categories />
            </div>
        </div>
    )
