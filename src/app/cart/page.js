            ...
            {selectedProducts.length &&
                <div className='flex mx-8 space-x-8'>
                                        ...
                                        <div className='flex my-4 items-center border rounded p-4'>
                                            ...
                                            <div className='ml-8'>
                                                ...
                                                <div className='flex items-center space-x-4 my-4'>
                                                    <button
                                                        className='text-center text-xl text-white bg-red-700 rounded-full w-8 h-8 opacity-100 hover:opacity-50'
                    ...
                    <form
                        ...
                        className='m-4 bg-red-700 rounded h-max' // Changed to red
                    >
                        ...
                        <div className='m-4'>
                            <button
                                className='w-full bg-red-950 text-white rounded opacity-100 
